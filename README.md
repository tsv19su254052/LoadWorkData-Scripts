...
Структура хранилища с базами данных:
 ...
 - Вариант в работе - базы со справочниками на одном сервере, база с оперативными данными на другом. Отладка автономными распределенными запросами с распределенными транзакциями, иногда обернутыми в обработку исключения, и хранимыми процедурами.
