...
Интерпретаторы Java и Python устанавливаеются дополнительно заранее. Модули машинного обучения устанавливаются в процессе установки. Отладка автономными распределенными запросами и хранимыми процедурами с разнесенными транзакциями, иногда обернутыми в обработку исключения.
