Базы данных и структуры данных, запросы, схемы, преобразования.
----

Структура хранилища с базами данных:
 - В разработке **Снежинка** - в центре таблицы с рабочими и оперативными данными (далее по тексту **данными**), с краев таблицы со справочными данными (далее по тексту **справочниками**).
 - В работе базы со справочниками на одном сервере, база с данными на другом. Отладка автономными распределенными запросами с распределенными транзакциями, иногда обернутыми в обработку исключения, и хранимыми процедурами.
