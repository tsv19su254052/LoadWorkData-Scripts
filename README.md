...
Структура хранилища с базами данных **Снежинка** - в центре таблицы с рабочими и оперативными данными (далее по тексту **данными**), с краев таблицы со справочными данными (далее по тексту **справочниками**). Далее в работе базы со справочниками на одном сервере, база с данными на другом. Отладка автономными распределенными запросами и хранимыми процедурами с разнесенными транзакциями, иногда обернутыми в обработку исключения.
