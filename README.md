...
Аттрибуты-идентификаторы в разных XML-ных полях могут указывать на одну и ту же авиакомпанию (см. второй абзац ["Считаем, что ..."](https://github.com/tsv19su254052/LoadWorkData-GUIs-and-Utilities)).
...
Теперь можно не писать **XSD-схему** вручную с нуля, а сгенерировать ее внутри `Management Studio` (аскетичнее, архаичнее, но срабатывает точнее, см. пример ниже)
...
или внутри `pyCharm` (удобнее в плане подсветки синтаксиса и автодополнения, есть навигация по структуре, см. пример ниже).
