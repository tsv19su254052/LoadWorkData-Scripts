...
Структура хранилища с базами данных:
 ...
 - Вариант в работе - справочники на одном сервере, оперативные данные - на другом. Отладка автономными распределенными запросами с распределенными транзакциями, иногда обернутыми в обработку исключения.
