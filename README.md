...
Файлы данных `*.mdf` размещаем на отдельном корпоративном быстром желательно SAS-овском HDD средней емкости (интенсивное чтение и запись в разные места), файлы журналов `*.ldf` - на обычном SATA-овом HDD большой емкости (медленная дозапись в конец), файлы данных и журнала `tempdb` - на отдельном HDD или NVMe средней емкости.
...
![SSMS СУБД Полная - Простая - Сжатие - Полная 002](https://github.com/tsv19su254052/LoadWorkData-Scripts/assets/104857185/fab668d1-17a0-44e2-b876-bc8bc90a98e7)
